...
class HomeViewController: UIViewController, HomeViewControllerType {
	...
	override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
		...
		let presenter = CityInformationPresenterImplementation(currentWeatherDataService: CurrentWeatherDataServiceImplementation(), cityWeatherPersistanceHelper: CityWeatherPersistanceHelperImplementation(userDefaultsHelper: UserDefaultsHelperImplementation()), userDefaultsHelper: UserDefaultsHelperImplementation())
